...
::set variables
set UPDATE_TAGS_URL=http://ignition.local/system/webdev/HomeAutomation/utility/tagControl/updateTags
set TAGFOLDER=/usr/local/bin/ignition/data/tags
set CHECK_GWINFO_URL=http://ignition.local/system/gwinfo
